...
short, human-readable notes for each other.  Frontend-agnostic: works with
Discord, Teams, or any future integration.
...
class LoungeMessage:
    ...
    thread_id: int | None = field(default=None)  # Thread/conversation that posted this
